...
1. Either run `composer require carlosrgzm/toastr-5-laravel` or add `"carlosrgzm/toastr-5-laravel": "~2.0"` to the `require` key in `composer.json` and run `composer install`
